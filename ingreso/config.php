<?php
//Variables principales de conexion a BD
$dbhost="localhost"; // Servidor
$dbusername="root"; // Nombre de usuario
$dbuserpass="Matl066"; // Contraseña
$dbname="intranet"; // Nombre de la base de datos
session_start();
...
if(isset($_COOKIE["id_extreme"])) 
{
	...
	{ 
		...
		//$query = mysql_query("SELECT * FROM usuarios WHERE username='".$user."'") or die(mysql_error());
