...
if ($_POST['username']) {
    ...
    if ($password == null) {
        ...
        $query = mysql_query("SELECT username,password FROM usuarios WHERE username = '$username'") or
            die(mysql_error());
        ...
        if ($data['password'] != $password) {
            ...
            if ($_POST['recordar']) {
                ...
                $query = mysql_query("UPDATE usuarios SET id_extreme='" . $id_extreme .
                    "' WHERE username='" . $username2 . "'") or die(mysql_error());
            }
